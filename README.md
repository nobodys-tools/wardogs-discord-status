...
`test2 / port 2` on rcon.wardogs.com is a demo that lives *inside that web page* — there is
nothing to connect to. Use the bundled mock instead:
...
Panel layout inspired by [pepershow2212/minitoring](https://github.com/pepershow2212/minitoring).
